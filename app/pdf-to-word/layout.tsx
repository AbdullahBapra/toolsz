...
const breadcrumbLd = getBreadcrumbLd("pdf-to-word");
const webAppLd = getWebApplicationLd("pdf-to-word");
const faqLd = getFaqPageLd("pdf-to-word");
const howToLd = getHowToLd("pdf-to-word");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="pdf-to-word" />
    </>
  );
}
