...
const breadcrumbLd = getBreadcrumbLd("compress-image");
const webAppLd = getWebApplicationLd("compress-image");
const faqLd = getFaqPageLd("compress-image");
const howToLd = getHowToLd("compress-image");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="compress-image" />
    </>
  );
}
