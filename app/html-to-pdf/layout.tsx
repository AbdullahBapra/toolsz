...
const breadcrumbLd = getBreadcrumbLd("html-to-pdf");
const webAppLd = getWebApplicationLd("html-to-pdf");
const faqLd = getFaqPageLd("html-to-pdf");
const howToLd = getHowToLd("html-to-pdf");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="html-to-pdf" />
    </>
  );
}
