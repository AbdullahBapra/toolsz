...
const breadcrumbLd = getBreadcrumbLd("regex-tester");
const webAppLd = getWebApplicationLd("regex-tester");
const faqLd = getFaqPageLd("regex-tester");
const howToLd = getHowToLd("regex-tester");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="regex-tester" />
    </>
  );
}
