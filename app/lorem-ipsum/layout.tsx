...
const breadcrumbLd = getBreadcrumbLd("lorem-ipsum");
const webAppLd = getWebApplicationLd("lorem-ipsum");
const faqLd = getFaqPageLd("lorem-ipsum");
const howToLd = getHowToLd("lorem-ipsum");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="lorem-ipsum" />
    </>
  );
}
