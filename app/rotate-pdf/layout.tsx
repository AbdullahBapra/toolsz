...
const breadcrumbLd = getBreadcrumbLd("rotate-pdf");
const webAppLd = getWebApplicationLd("rotate-pdf");
const faqLd = getFaqPageLd("rotate-pdf");
const howToLd = getHowToLd("rotate-pdf");
