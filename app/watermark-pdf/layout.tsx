...
const breadcrumbLd = getBreadcrumbLd("watermark-pdf");
const webAppLd = getWebApplicationLd("watermark-pdf");
const faqLd = getFaqPageLd("watermark-pdf");
const howToLd = getHowToLd("watermark-pdf");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="watermark-pdf" />
    </>
  );
}
