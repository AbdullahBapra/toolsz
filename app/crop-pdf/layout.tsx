...
const breadcrumbLd = getBreadcrumbLd("crop-pdf");
const webAppLd = getWebApplicationLd("crop-pdf");
const faqLd = getFaqPageLd("crop-pdf");
const howToLd = getHowToLd("crop-pdf");
