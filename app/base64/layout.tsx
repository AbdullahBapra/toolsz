...
const breadcrumbLd = getBreadcrumbLd("base64");
const webAppLd = getWebApplicationLd("base64");
const faqLd = getFaqPageLd("base64");
const howToLd = getHowToLd("base64");
