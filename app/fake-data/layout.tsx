...
const breadcrumbLd = getBreadcrumbLd("fake-data");
const webAppLd = getWebApplicationLd("fake-data");
const faqLd = getFaqPageLd("fake-data");
const howToLd = getHowToLd("fake-data");
