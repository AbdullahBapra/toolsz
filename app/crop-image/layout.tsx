...
const breadcrumbLd = getBreadcrumbLd("crop-image");
const webAppLd = getWebApplicationLd("crop-image");
const faqLd = getFaqPageLd("crop-image");
const howToLd = getHowToLd("crop-image");
