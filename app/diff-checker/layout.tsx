...
const breadcrumbLd = getBreadcrumbLd("diff-checker");
const webAppLd = getWebApplicationLd("diff-checker");
const faqLd = getFaqPageLd("diff-checker");
const howToLd = getHowToLd("diff-checker");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="diff-checker" />
    </>
  );
}
