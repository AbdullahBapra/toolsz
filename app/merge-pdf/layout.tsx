...
const breadcrumbLd = getBreadcrumbLd("merge-pdf");
const webAppLd = getWebApplicationLd("merge-pdf");
const faqLd = getFaqPageLd("merge-pdf");
const howToLd = getHowToLd("merge-pdf");
