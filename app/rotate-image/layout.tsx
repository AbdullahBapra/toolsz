...
const breadcrumbLd = getBreadcrumbLd("rotate-image");
const webAppLd = getWebApplicationLd("rotate-image");
const faqLd = getFaqPageLd("rotate-image");
const howToLd = getHowToLd("rotate-image");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="rotate-image" />
    </>
  );
}
