...
const breadcrumbLd = getBreadcrumbLd("word-counter");
const webAppLd = getWebApplicationLd("word-counter");
const faqLd = getFaqPageLd("word-counter");
const howToLd = getHowToLd("word-counter");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="word-counter" />
    </>
  );
}
