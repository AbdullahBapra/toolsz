...
const breadcrumbLd = getBreadcrumbLd("organize-pdf");
const webAppLd = getWebApplicationLd("organize-pdf");
const faqLd = getFaqPageLd("organize-pdf");
const howToLd = getHowToLd("organize-pdf");
...
export default function ToolLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {children}
      <ToolSeoFooter slug="organize-pdf" />
    </>
  );
}
