...
const breadcrumbLd = getBreadcrumbLd("remove-bg");
const webAppLd = getWebApplicationLd("remove-bg");
const faqLd = getFaqPageLd("remove-bg");
const howToLd = getHowToLd("remove-bg");
